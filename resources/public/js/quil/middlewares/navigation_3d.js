...
var vec__25775 = axis;
var a_x = cljs.core.nth.call(null,vec__25775,(0),null);
var a_y = cljs.core.nth.call(null,vec__25775,(1),null);
var a_z = cljs.core.nth.call(null,vec__25775,(2),null);
var vec__25778 = v;
var x = cljs.core.nth.call(null,vec__25778,(0),null);
var y = cljs.core.nth.call(null,vec__25778,(1),null);
var z = cljs.core.nth.call(null,vec__25778,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__25781,p__25782){
var vec__25783 = p__25781;
var u1 = cljs.core.nth.call(null,vec__25783,(0),null);
var u2 = cljs.core.nth.call(null,vec__25783,(1),null);
var u3 = cljs.core.nth.call(null,vec__25783,(2),null);
var vec__25786 = p__25782;
var v1 = cljs.core.nth.call(null,vec__25786,(0),null);
var v2 = cljs.core.nth.call(null,vec__25786,(1),null);
var v3 = cljs.core.nth.call(null,vec__25786,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__25789_SHARP_){
return (p1__25789_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__25790_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__25791_SHARP_,angle_lr),angle_ud);
...
var map__25793 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__25793__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__25793__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__25795 = cljs.core._EQ_;
var expr__25796 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__25795.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__25796))){
return straight;
} else {
if(cljs.core.truth_(pred__25795.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__25796))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__25795.call(null,quil.middlewares.navigation_3d.space,expr__25796))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__25795.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__25796))){
return up;
} else {
if(cljs.core.truth_(pred__25795.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__25796))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__25795.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__25796))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__25793,map__25793__$1,up,straight){
return (function (p1__25792_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__25792_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__25793,map__25793__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__25798_SHARP_);
});})(initial_state))
);
});
/**
...
var map__25799_25810 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__25799_25811__$1 = ((((!((map__25799_25810 == null)))?(((((map__25799_25810.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25799_25810.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25799_25810):map__25799_25810);
var vec__25800_25812 = cljs.core.get.call(null,map__25799_25811__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_25813 = cljs.core.nth.call(null,vec__25800_25812,(0),null);
var c_y_25814 = cljs.core.nth.call(null,vec__25800_25812,(1),null);
var c_z_25815 = cljs.core.nth.call(null,vec__25800_25812,(2),null);
var vec__25803_25816 = cljs.core.get.call(null,map__25799_25811__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_25817 = cljs.core.nth.call(null,vec__25803_25816,(0),null);
var u_y_25818 = cljs.core.nth.call(null,vec__25803_25816,(1),null);
var u_z_25819 = cljs.core.nth.call(null,vec__25803_25816,(2),null);
var vec__25806_25820 = cljs.core.get.call(null,map__25799_25811__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_25821 = cljs.core.nth.call(null,vec__25806_25820,(0),null);
var p_y_25822 = cljs.core.nth.call(null,vec__25806_25820,(1),null);
var p_z_25823 = cljs.core.nth.call(null,vec__25806_25820,(2),null);
quil.core.camera.call(null,p_x_25821,p_y_25822,p_z_25823,(p_x_25821 + c_x_25813),(p_y_25822 + c_y_25814),(p_z_25823 + c_z_25815),u_x_25817,u_y_25818,u_z_25819);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1535432641568
