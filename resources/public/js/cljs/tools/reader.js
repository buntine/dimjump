...
var G__20452 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__20452;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__20453 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__20453,ch);
...
if(("\\" === ch__$1)){
var ch_20454__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_20454__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_20454__$2);
} else {
}

var G__20455 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__20455;
continue;
}
}
...
var vec__20463 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__20463,(0),null);
var start_column = cljs.core.nth.call(null,vec__20463,(1),null);
...
var G__20466 = cljs.core.conj_BANG_.call(null,a,form);
a = G__20466;
continue;
}
}
...
var _STAR_read_delim_STAR_20467 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_20467;
}});
/**
...
var vec__20474 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__20474,(0),null);
var start_column = cljs.core.nth.call(null,vec__20474,(1),null);
...
var vec__20477 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__20477,(0),null);
var end_column = cljs.core.nth.call(null,vec__20477,(1),null);
...
var vec__20480 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__20480,(0),null);
var start_column = cljs.core.nth.call(null,vec__20480,(1),null);
...
var vec__20483 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__20483,(0),null);
var end_column = cljs.core.nth.call(null,vec__20483,(1),null);
...
var sb = (function (){var G__20486 = (new goog.string.StringBuffer());
G__20486.append(initch);
...
var G__20488 = (function (){var G__20487 = sb;
G__20487.append(ch);

return G__20487;
})();
var G__20489 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__20488;
ch = G__20489;
continue;
}
...
switch (G__20492) {
case "\\":
var G__20496 = (function (){var G__20493 = sb;
G__20493.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__20493;
})();
var G__20497 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__20496;
ch = G__20497;
continue;
...
break;
default:
var G__20498 = (function (){var G__20494 = sb;
G__20494.append(ch);

return G__20494;
})();
var G__20499 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__20498;
ch = G__20499;
continue;
...
var vec__20500 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__20500,(0),null);
var end_column = cljs.core.nth.call(null,vec__20500,(1),null);
...
var vec__20503 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__20503,(0),null);
var column = cljs.core.nth.call(null,vec__20503,(1),null);
...
var vec__20508 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__20508,(0),null);
var column = cljs.core.nth.call(null,vec__20508,(1),null);
...
var vec__20513 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__20513,(0),null);
var column = cljs.core.nth.call(null,vec__20513,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__20518 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__20518,(0),null);
var start_column = cljs.core.nth.call(null,vec__20518,(1),null);
...
var vec__20521 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__20521,(0),null);
var end_column = cljs.core.nth.call(null,vec__20521,(1),null);
...
var G__20524 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__20524,true,null,opts,pending_forms);
...
var G__20525 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__20525)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__20525)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__20525)){
...
var _STAR_suppress_read_STAR_20526 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_20526;
}});
...
var G__20527 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__20527,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__20527,rdr,first_line);
...
var G__20531 = matched;
var G__20532 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__20531;
finished = G__20532;
continue;
} else {
...
var _STAR_suppress_read_STAR_20533 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_20533;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env20534 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__20535 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__20535,"(");
...
var G__20536 = (i + (1));
var G__20537 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env20534;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__20538 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__20538);
...
var G__20541 = cljs.core.next.call(null,s);
var G__20542 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__20541;
key_vals = G__20542;
continue;
} else {
...
var gensym_env20546 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env20546;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__20547 = token;
var G__20547__$1 = (((G__20547 == null))?null:cljs.core.subs.call(null,G__20547,(1)));
var G__20547__$2 = (((G__20547__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__20547__$1));
var G__20547__$3 = (((G__20547__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__20547__$2));
var G__20547__$4 = (((G__20547__$3 == null))?null:cljs.core.symbol.call(null,G__20547__$3));
if((G__20547__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__20547__$4);
}
})():(function (){var G__20548 = token;
var G__20548__$1 = (((G__20548 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__20548));
if((G__20548__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__20548__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
}catch (e20555){if((e20555 instanceof Error)){
var e = e20555;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__20559,reader){
...
var eof = cljs.core.get.call(null,map__20560__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq20566){
var G__20567 = cljs.core.first.call(null,seq20566);
var seq20566__$1 = cljs.core.next.call(null,seq20566);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20567,seq20566__$1);
});


//# sourceMappingURL=reader.js.map?rel=1535420493911
