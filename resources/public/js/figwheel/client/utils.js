...
return (new CustomEvent(event_name,(function (){var obj24903 = {"detail":data};
return obj24903;
})()));
} else {
...
var f = (function (){var pred__24910 = cljs.core._EQ_;
var expr__24911 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24910.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24911))){
return ((function (pred__24910,expr__24911){
return (function (p1__24904_SHARP_){
return console.warn(p1__24904_SHARP_);
});
;})(pred__24910,expr__24911))
} else {
if(cljs.core.truth_(pred__24910.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24911))){
return ((function (pred__24910,expr__24911){
return (function (p1__24905_SHARP_){
return console.debug(p1__24905_SHARP_);
});
;})(pred__24910,expr__24911))
} else {
if(cljs.core.truth_(pred__24910.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24911))){
return ((function (pred__24910,expr__24911){
return (function (p1__24906_SHARP_){
return console.error(p1__24906_SHARP_);
});
;})(pred__24910,expr__24911))
} else {
return ((function (pred__24910,expr__24911){
return (function (p1__24907_SHARP_){
return console.log(p1__24907_SHARP_);
});
;})(pred__24910,expr__24911))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24914){
...
var eval_fn = cljs.core.get.call(null,map__24915__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__24917_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__24919,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1535420497280
